# Toolhouse (toolhouse)
Toolhouse is a Backend-as-a-Service platform for building, deploying, and managing AI agents. Developers define agents as code and deploy them as APIs, with automatic access to over 40 pre-built tools and integrations with major LLM providers.

**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/toolhouse/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - AI Agents, Tools, Backend as a Service, Agent Infrastructure
...
#### Tags:
 ...
 - AI Agents, Tools, Agent Runs, Management

#### Properties

- [Documentation](https://docs.toolhouse.ai/toolhouse)
- [OpenAPI](https://api.toolhouse.ai/openapi.json)
...
#### Tags:
 ...
 - AI Agents, Execution, Streaming, Conversations

#### Properties

- [Documentation](https://docs.toolhouse.ai/toolhouse/advanced-concepts/publish-and-run-your-agents)
